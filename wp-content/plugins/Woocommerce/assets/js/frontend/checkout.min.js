jQuery(function(g) {
    ...
    var f = {
        ...
        init: function() {
            g(document.body).on("update_checkout", this.update_checkout),
            g(document.body).on("init_checkout", this.init_checkout),
            ...
            "yes" === wc_checkout_params.option_guest_checkout && g("input#createaccount").on("change", this.toggle_create_account).trigger("change")
        },
        init_payment_methods: function() {
            var e = g(".woocommerce-checkout").find('input[name="payment_method"]')
              , t = (1 === e.length && e.eq(0).hide(),
            f.selectedPaymentMethod && g("#" + f.selectedPaymentMethod).prop("checked", !0),
            0 === e.filter(":checked").length && e.eq(0).prop("checked", !0),
            e.filter(":checked").eq(0).prop("id"));
        ...
        payment_method_selected: function(e) {
            e.stopPropagation(),
            1 < g(".payment_methods input.input-radio").length ? (e = g("div.payment_box." + g(this).attr("ID")),
            (t = g(this).is(":checked")) && !e.is(":visible") && (g("div.payment_box").filter(":visible").slideUp(230),
            t) && e.slideDown(230)) : g("div.payment_box").show(),
            ...
            t !== f.selectedPaymentMethod && g(document.body).trigger("payment_method_selected"),
            f.selectedPaymentMethod = t
        },
        toggle_create_account: function() {
            g("div.create-account").hide(),
            g(this).is(":checked") && (g("#account_password").val("").trigger("change"),
        ...
        input_changed: function(e) {
            f.dirtyInput = e.target,
            f.maybe_update_checkout()
        },
        queue_update_checkout: function(e) {
            ...
            f.updateTimer = setTimeout(f.maybe_update_checkout, "1000")
        },
        ...
        validate_field: function(e) {
            var t = g(this)
              ...
              , a = ""
              , e = e.type;
            "input" === e && o.removeClass("woocommerce-invalid woocommerce-invalid-required-field woocommerce-invalid-email woocommerce-invalid-phone woocommerce-validated"),
            "validate" !== e && "change" !== e || (i && ("checkbox" === t.attr("type") && !t.is(":checked") || "" === t.val()) && (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-required-field"),
            c = !1),
            n && t.val() && !(a = new RegExp(/^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i)).test(t.val()) && (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-email woocommerce-invalid-phone"),
            c = !1),
            r && (a = new RegExp(/[\s\#0-9_\-\+\/\(\)\.]/g),
            0 < t.val().replace(a, "").length) && (o.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-phone"),
            c = !1),
            c && o.removeClass("woocommerce-invalid woocommerce-invalid-required-field woocommerce-invalid-email woocommerce-invalid-phone").addClass("woocommerce-validated"))
        },
        update_checkout: function(e, t) {
            f.reset_update_checkout_timer(),
            f.updateTimer = setTimeout(f.update_checkout_action, "5", t)
        },
        update_checkout_action: function(e) {
            var t, o, c, i, n, r, a, u, d, s, m, l, h, p, _;
            f.xhr && f.xhr.abort(),
            0 !== g("form.checkout").length && (e = void 0 !== e ? e : {
                update_shipping_method: !0
            },
            a = t = g("#billing_country").val(),
            u = o = g("#billing_state").val(),
            d = c = g(":input#billing_postcode").val(),
            s = i = g("#billing_city").val(),
            m = n = g(":input#billing_address_1").val(),
            l = r = g(":input#billing_address_2").val(),
            p = g(f.$checkout_form).find(".address-field.validate-required:visible"),
            h = !0,
            ...
            f.xhr = g.ajax({
                ...
                success: function(e) {
                    var t, o;
                    e && !0 === e.reload ? window.location.reload() : (g(".woocommerce-NoticeGroup-updateOrderReview").remove(),
                    o = g("#terms").prop("checked"),
                    t = {},
                    ...
                    e && e.fragments && (g.each(e.fragments, function(e, t) {
                        f.fragments && f.fragments[e] === t || g(e).replaceWith(t),
                        g(e).unblock()
                    }),
                    f.fragments = e.fragments),
                    o && g("#terms").prop("checked", !0),
                    g.isEmptyObject(t) || g(".payment_box :input").each(function() {
                        var e = g(this).attr("id");
                    ...
                    e && "failure" === e.result && (o = g("form.checkout"),
                    g(".woocommerce-error, .woocommerce-message").remove(),
                    e.messages ? o.prepend('<div class="woocommerce-NoticeGroup woocommerce-NoticeGroup-updateOrderReview">' + e.messages + "</div>") : o.prepend(e),
                    o.find(".input-text, select, input:checkbox").trigger("validate").trigger("blur"),
                    f.scroll_to_notices()),
                    f.init_payment_methods(),
        ...
        submit: function() {
            ...
            placeOrderBtn.text('Order processing, please wait');
            placeOrderBtn.prop('disabled', true);
            return o.is(".processing") || !1 !== o.triggerHandler("checkout_place_order", [f]) && !1 !== o.triggerHandler("checkout_place_order_" + f.get_payment_method(), [f]) && (o.addClass("processing"),
            f.blockOnSubmit(o),
            f.attachUnloadEventsOnSubmit(),
            g.ajaxSetup({
                dataFilter: function(e, t) {
                    return "json" !== t || f.is_valid_json(e) || (null !== (t = e.match(/{"result.*}/)) && f.is_valid_json(t[0]) ? (console.log("Fixed malformed JSON. Original:"),
                    console.log(e),
                    e = t[0]) : console.log("Unable to fix malformed JSON")),
                    e
                }
            }),
            g.ajax({
                ...
                success: function(e) {
                    ...
                    try {
                        if ("success" !== e.result || !1 === o.triggerHandler("checkout_place_order_success", [e, f]))
                        ...
                        !0 === e.reload ? window.location.reload() : (!0 === e.refresh && g(document.body).trigger("update_checkout"),
                        e.messages ? f.submit_error(e.messages) : f.submit_error('<div class="woocommerce-error">' + wc_checkout_params.i18n_checkout_error + "</div>"))
                    }
                },
                error: function(e, t, o) {
                    f.detachUnloadEventsOnSubmit(),
                    f.submit_error('<div class="woocommerce-error">' + (o || wc_checkout_params.i18n_checkout_error) + "</div>")
                }
            })),
            !1
        },
        submit_error: function(e) {
            var placeOrderBtn = jQuery('#place_order');
			placeOrderBtn.show();
			placeOrderBtn.text(placeOrderBtn.val());
			placeOrderBtn.prop('disabled', false);
            g(".woocommerce-NoticeGroup-checkout, .woocommerce-error, .woocommerce-message").remove(),
            f.$checkout_form.prepend('<div class="woocommerce-NoticeGroup woocommerce-NoticeGroup-checkout">' + e + "</div>"),
            f.$checkout_form.removeClass("processing").unblock(),
            f.$checkout_form.find(".input-text, select, input:checkbox").trigger("validate").trigger("blur"),
            f.scroll_to_notices(),
            g(document.body).trigger("checkout_error", [e])
        },
      ...
      , e = {
        init: function() {
            ...
            g("form.checkout_coupon").hide().on("submit", this.submit)
        },
        ...
        submit: function() {
            var t, o = g(this);
            return o.is(".processing") || (o.addClass("processing").block({
                message: null,
                overlayCSS: {
                    background: "#fff0",
                    opacity: .6
            ...
            g.ajax({
                ...
                success: function(e) {
                    ...
                    e && (o.before(e),
                    o.slideUp(),
                    g(document.body).trigger("applied_coupon_in_checkout", [t.coupon_code]),
                    g(document.body).trigger("update_checkout", {
        ...
        remove_coupon: function(e) {
            ...
            g.ajax({
                ...
                success: function(e) {
                    ...
                    g(document.body).trigger("removed_coupon_in_checkout", [o.coupon]),
                    g(document.body).trigger("update_checkout", {
                        update_shipping_method: !1
                    }),
