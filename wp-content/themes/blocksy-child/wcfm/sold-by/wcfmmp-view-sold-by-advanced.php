...
<div class="wcfmmp_sold_by_container_advanced">
	...
	<?php if( apply_filters( 'wcfmmp_is_allow_full_sold_by_linked', false ) && apply_filters( 'wcfmmp_is_allow_sold_by_linked', true ) ) { ?><a target="_self" href="<?php echo wcfmmp_get_store_url( $vendor_id ); ?>"><?php } ?>
